...
build/tests/posix/test_sockopt: tests/posix/test_sockopt.c | build/tests/posix
	$(CC) $(CFLAGS) $< -o $@

build/tests/posix/test_addr: tests/posix/test_addr.c | build/tests/posix
	$(CC) $(CFLAGS) $< -o $@

tests: build/tests/spinlock_fairness build/tests/posix/test_file build/tests/posix/test_process build/tests/posix/test_sockopt build/tests/posix/test_addr
...
check: all tests
	...
	./build/tests/posix/test_sockopt
	./build/tests/posix/test_addr
