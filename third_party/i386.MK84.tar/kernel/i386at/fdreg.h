 ...
 * HISTORY
 * $Log:	fdreg.h,v $
 * Revision 2.7  93/11/17  16:45:46  dbg
 * 	Changed HZ to hz.  Removed local declaration of HZ.
...
#ifndef	_I386AT_FDREG_H_
#define	_I386AT_FDREG_H_
