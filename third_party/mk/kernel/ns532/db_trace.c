 ...
 *	Add null stab so call of db_symbol_values matches definition (and
 *	prototype).
 *
 ...
 *
 * $Log: db_trace.c,v $
 * Revision 1.17  1992/05/14  19:51:22  kivinen
 * 	Fixed indention.
 *
 * Revision 1.16  1992/05/11  19:23:36  kivinen
 * 	Rewrote db_stack_trace_cmd and db_nextframe.
 *
 */
/*
