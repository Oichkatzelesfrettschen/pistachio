...
#	Made bsd_types_gen rule a bit more cross compilable.
#
# $Log:	template.mk,v $
...
bsd_types_gen.o : bsd_types_gen.c
	${_host_CC_} -c ${_CCFLAGS_} bsd_types_gen.c

bsd_types_gen.c : uxkern/bsd_types_gen.c
	rm -f bsd_types_gen.c
	${CPP} ${_CPPFLAGS_} ${uxkern/bsd_types_gen.c:P} > bsd_types_gen.c
