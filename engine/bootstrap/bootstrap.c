 ...
 * HISTORY
 * $Log:	bootstrap.c,v $
 * Revision 2.11  93/11/17  15:57:23  dbg
 * 	Since Dos cannot take long filenames, have a second
 * 	try with "ms" if "mach_servers" fails.
 * 	Make test for dir filesystem indep.
 * 	[93/09/14  11:53:18  af]
 * 
...
char	*root_name = "";
char	*server_dir_base_name = "/mach_servers";
char	*server_dir_altbase_name = "/ms"; /* shorter, makes DOS happy */
char	server_dir_name[MAXPATHLEN];
