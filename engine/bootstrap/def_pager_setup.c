 ...
 * Revision 2.11  93/11/17  15:57:44  dbg
 * 	open+add_file_direct --> make_file_direct.
 * 	[93/09/14  11:50:48  af]
 * 
	...
	char			*file_name;
{
	...
	result = make_file_direct(&pfile, fdp);
	if (result)
		panic("Can't make a direct-paging file of %s\n", file_name);
